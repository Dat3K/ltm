    ...
    public DaytimClient() {
        ...
        getButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                resultArea.setText("DaytimClient functionality will be implemented in the future.\n");
                resultArea.append("This will connect to the daytime server at " + 
                               hostField.getText() + ":" + portField.getText() + 
                               " and display the current time.");
            }
        });
    }
}
