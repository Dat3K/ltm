    ...
    public GetLocalAddress() {
        ...
        getButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                resultArea.setText("GetLocalAddress functionality will be implemented in the future.\n");
                resultArea.append("This will display the local address when connecting to " + 
